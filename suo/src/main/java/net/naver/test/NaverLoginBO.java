...
public class NaverLoginBO {
	...
	//state: ���ø����̼��� ������ ���� ��ū
	private final static String CLIENT_ID = "D9nc54TSHW2ZJyODjSmC";
	private final static String CLIENT_SECRET = "FxGVVfb8AE";
	private final static String REDIRECT_URI = "http://localhost:8099/callback";
