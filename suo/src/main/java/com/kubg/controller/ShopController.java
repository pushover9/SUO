...
public class ShopController {
	...
	public void getView(@RequestParam("n") int gdsNum, Model model) {
			...
			GoodViewVO view = service.goodsView(gdsNum)	;	
...
//	}
	...
	public String getReplyList(ReplyVO reply,HttpSession session) throws Exception {
	...
	public String modifyReply(ReplyVO reply, HttpSession session) throws Exception {
