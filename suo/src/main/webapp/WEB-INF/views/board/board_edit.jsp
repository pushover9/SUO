...
<section class="page-section">
	...
	<div class="col-lg-10 my-4 mb-4 border border-dark rounded-lg">
		<form method="post" action="board_edit_ok" onsubmit="return check();" enctype="multipart/form-data">
			<input type="hidden" name="bno" value="${b.bno }"/>
  			<input type="hidden" name="page" value="${page }"/>
			
			<input class="form-control mt-4 mb-2" value="${b.title}" name="title" id="title" class="form-control mt-4 mb-2" placeholder="제목을 입력하세요"/>
			...
			rows="10" cols="36" placeholder="내용을 입력하세요"> ${b.content}</textarea>
			
			<div class="mt-2 text-center">
				<input  class="btn btn-secondary mb-3" type="submit" value="수정 완료" />
				<input  class="btn btn-secondary mb-3" type="reset" value="등록 취소" onclick="$('#title').focus();" />
			</div>
		</form>
	</div>
	</div>
