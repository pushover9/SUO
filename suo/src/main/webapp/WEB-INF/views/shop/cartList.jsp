			...
			<div class="orderInfo">
				<form role="form" method="post" autocomplete="off">
					...
					<div class="inputArea">
						...
						<input type="number" name="orderPhon" id="orderPhon" required="required" />
					</div>
					<!-- 
					<div class="inputArea">
					...
					<div class="inputArea">
						...
						<p>
							<input type="text" name="userAddr1" id="sample2_address" placeholder="주소" readonly>
							<input type="text" name="userAddr2" id="sample2_detailAddress" placeholder="상세주소" required="required">
