...
<section class="page-section">
   ...
   <article class="container mt-3">
      <form method="post" action="/find_pw_ok" onsubmit="return check(this)">
      ...
      <div class="col-sm-6 col-md-offset-3">
            <div class="form-group mb-6">
               ...
               <input type="text" name="user_id" class="form-control user_id" placeholder="이름을 입력해 주세요">
            </div>
            ...
            <div class="form-group">
               ...
               <c:if test="${!empty up_pw}">
                  
                  <label for="find_id" class="mt-3">임시 비밀번호는 "${up_pw}" 입니다!</label>
                  <label for="find_id" class="mt-3">반드시 회원정보에서 수정해주시기 바랍니다.</label>
            ...
            <div class="form-group text-center">
               <button type="submit" id="join-submit" class="btn btn-primary">
                  임시비밀번호 발급<i class="fa fa-check spaceLeft"></i>
               </button>
