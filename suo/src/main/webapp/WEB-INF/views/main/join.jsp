   ...
   $(function(){
      ...
      pw2.on("keyup",function(){
         if(pw.val() ==pw2.val()){
            ...
            $mark="<font color='red' size='3'>비밀번호 불일치.</font>";
            $('.pwcheck').text('');
            $('.pwcheck').show();
            $('.pwcheck').append($mark);
            return false;
...
<section>
   ...
   <article class="container">
      ...
      <div class="col-sm-6 col-md-offset-3">
         <form role="form" method="post"action="/join_ok" onsubmit="return join_check(this)">
            <div class="form-group">
               <label for="user_name">아이디</label>
               <div style="display:flex; flex-direction:row;"> 
                  <input type="text" name="user_id" style="width:60%;" class="form-control col-xs-5" id="user_id" placeholder="이름을 입력해 주세요">
                  <input type="button" class="check_btn" value="중복검색" style="width:40%;" onclick="id_check();" />
               </div>    
