...
<div class="inputArea">
	...
	<input type="number" id="gdsPrice" name="gdsPrice" value="${goods.gdsPrice }" />
</div>

<div class="inputArea">
	<label for="gdsStock">상품수량</label>
	<input type="number" id="gdsStock" name="gdsStock" value="${goods.gdsStock }"/>
</div>
...
<div class="inputArea">
	<input type="submit" id="register_Btn" class="btn btn-primary" value="수정">
...
$(document).on("change", "select.category1", function(){
	 ...
	 */
	 ...
	 $("option:selected", this).each(function(){
	  ...
	  cate2Select.append("<option value='"+ selectVal+"'></option>");
